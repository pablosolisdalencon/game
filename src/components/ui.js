...
import PlayerStatusMenu from './client/PlayerStatusMenu';
import InteractiveCityMap from './client/InteractiveCityMap';

export default function UI() {
  // No more useState, useContext (usePlayerAccount), or handler functions here
    ...
    <>
      <div className="main-container">
        ...
        <div className="space-map">
            {/* text-2xl and font-bold are Tailwind classes or defined in global css */}
            <span className="text-2xl font-bold">SpaceMap</span>
        </div>

        <div className="city-map">
            <InteractiveCityMap officeData={officeData} />
        </div>
      ...
      {/* Modals are no longer rendered here; they are managed within InteractiveCityMap */}
    </>
  );
}